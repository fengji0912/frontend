...
import CustomFilters from '@/app/search/Sidebar/Filters/CustomFilters/CustomFilters';
...
import ListFilter from '@/app/search/Sidebar/Filters/ListFilter/ListFilter';
import Year from '@/app/search/Sidebar/Filters/Year/Year';
