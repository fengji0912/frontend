  ...
  return (
    <>
      <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end">
        <button
          className={`bg-[#e86161] text-white transition-transform transform ${
            isChatOpen ? 'translate-y-0' : 'translate-y-12'
          } rounded-lg`}
        ...
        >
          <div className="flex items-center">
            ...
            <span className="w-6 h-8 text-base font-medium">{'Chatbot'}</span>
          </div>
          <svg
